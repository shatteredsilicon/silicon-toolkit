...
# Base tools and compiler
BuildRequires:  coreutils
BuildRequires:  findutils
BuildRequires:  gcc
BuildRequires:  make

# Perl toolchain and base runtime
BuildRequires:  perl
...
# Delete unnecessary .bs files
find %{buildroot} -type f -name '*.bs' -empty -delete

# Remove perllocal.pod explicitly
...
%changelog
* Thu Jul 03 2025 Thien Nguyen <nthien86@gmail.com> 1.19-38
- Added provides
